...
/**
 * Action that that represents a toggled binary selected state. A component factory may create a checkbox or, if the action indicates a group, a radio button to
...
public abstract class AbstractToggleAction extends AbstractAction {
	...
	public boolean isSelected() {
		return Booleans.booleanValue(getValue(SELECTED_KEY));
	}
	...
	/**
	 * The group with which the action is associated, or <code>null</code> if no group is indicated.
	 */
	private final ActionGroup group;

	/**
	 * @return The group with which the action is associated, or <code>null</code> if no group is indicated.
	 */
	...
	/**
	 * Group constructor.
	 * @param group The group with which the action is associated, or <code>null</code> for new group.
	 */
