...
/**
 * Strategy for drawing a shape on a component. An instance of the strategy must be registered as both a {@link MouseListener} and a {@link MouseMotionListener}
 * with the component on which the shape will be drawn.
 * @see Drawable
...
public class DrawShapeStrategy extends MouseInputAdapter {
	...
	/**
	 * @return The object being drawn, or <code>null</code> if no shape is being drawn.
	 */
	 ...
	 * @param newDrawShape The new shape to draw, or <code>null</code> if no shape is to be drawn.
	 */
