...
/**
 * A view that displays a given component. The component must be created before this view is created, and this view merely stores the component until time for
 * its view "creation".
...
public class XMLComponentView extends XMLAbstractComponentView {
	...
	/**
	 * Creates a new component for this view to represent. Because this class requires a component to already be created before this view is created, this method
	 * really just returns the component that was already created.
