...
/**
 * Provides a block view with one or more components embedded. The children will be loaded as with a normal block view, except that the added components will be
 * visible in the view. The components are added using the constants from {@link BorderLayout} except for {@link BorderLayout#CENTER}. Implements
 * {@link ViewHidable} so that it can be notified if the view is being hidden so that it can hide the object.
...
public class XMLComponentBlockView extends XMLBlockView implements ViewComponentManageable, ViewHidable {
	...
	/**
	 * <code>true</code> if the view should update minimum insets to compensate for components located in the insets, or <code>false</code> if the normal insets
	 * should be used.
	 */
	private final boolean componentInsetsUpdated;

	/**
	 * @return <code>true</code> if the view should update minimum insets to compensate for components located in the insets, or <code>false</code> if the normal
	 *         insets should be used.
	 */
	protected boolean isComponentInsetsUpdated() {
		return componentInsetsUpdated;
	}
	...
	protected class XMLComponentFragmentBlockView extends XMLFragmentBlockView implements ViewComponentManageable, ViewHidable {
		...
		/**
		 * Sets the cached properties from the attributes. This version compensates for the inset components, if necessary.
