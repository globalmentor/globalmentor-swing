...
public class XMLAnonymousParagraphView //TODO del this class if we don't need
{
	...
	*/
	 ...
	 * directly, as they are created in the process of formatting. If the layoutPool variable is <code>null</code>, an instance of <code>LogicalView</code> is
	 ...
	 * specifically a <code>XMLParagraphView.LogicalView</code>, so that that view can implement its own special version of child view construction.
