...
public class ViewComponentManager //TODO finish the class comments with examples of usage
{
	 ...
	 * @return The managed component's information, <code>null</code> if there is no information stored for the specified component.
	 */
	...
	*/
	 ...
	 * @param newShowing <code>true</code> if the view is beginning to be shown, <code>false</code> if the view is beginning to be hidden.
	 */
	 ...
	 * @param showing <code>true</code> if the component should be shown, <code>false</code> if its should be hidden.
	 */
	 ...
	 * <code>paint()</code> does not have to extract information from the <code>Shape</code> it receives.
	 ...
	 * positioning that are either in <code>BEFORE</code> or <code>AFTER</code> positions. The component's current actual size is used for calculating minimum
	 * insets, which means it is assumed that <code>updateComponentPosition()</code> has already been called.
	 */
	...
	public static class ComponentInfo implements Cloneable {
		...
		/**
		 * The scaled location of the component relative to the scaled size of the view, or <code>null</code> if the scaled location isn't available.
		 */
		private Point scaledLocation = null;

		/**
		 * @return The scaled location of the component relative to the scaled size of the view, or <code>null</code> if the scaled location isn't available.
		 */
		 ...
		 * @param newScaledLocation The new scaled location of the component relative to the scaled size of the view, or <code>null</code> if the scaled location
		 *          isn't available.
		 */
		...
		/**
		 * The preferred size of the component relative to the original size of the view, or <code>null</code> if the size isn't available.
		 */
		private Dimension size = null;

		/**
		 * @return The preferred size of the component relative to the original size of the view, or <code>null</code> if the size isn't available.
		 */
		...
		/**
		 * The scaled size of the component relative to the scaled size of the view, or <code>null</code> if the scaled size isn't available.
		 */
		private Dimension scaledSize = null;

		/**
		 * @return The scaled size of the component relative to the scaled size of the view, or <code>null</code> if the scaled size isn't available.
		 */
		 ...
		 * @param newScaledSize The new scaled size of the component relative to the scaled size of the view, or <code>null</code> if the scaled size isn't
		 *          available.
		 */
