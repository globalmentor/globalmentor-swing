...
public class Bookmark implements Comparable, Position {
	...
	/**
	 * @return The name of the bookmark, or <code>null</code> if this bookmark has no name.
	 */
	 ...
	 * @param newName The name of the bookmark, or <code>null</code> if there should be no name.
	 */
	...
	/**
	 * @return The position within the document the bookmark represents, or <code>null</code> if the bookmark is not attached to a document.
	 */
	...
	/**
	 * @return The ending position within the document the bookmark represents, or <code>null</code> if the bookmark is not attached to a document.
	 */
	...
	*/
	 ...
	 * @param object The object with which to compare the component. This must be another <code>Bookmark</code> object.
