...
/**
 * A panel containing panels to edit fields for a vCard <code>text/directory</code> profile as defined in <a href="http://www.ietf.org/rfc/rfc2426.txt">RFC
...
public class VCardPanel extends TabbedViewPanel<VCard> implements Verifiable {
	...
	public IdentificationPanel getIdentificationPanel() {
	...
	public TelecommunicationsPanel getTelecommunicationsPanel() {
		return telecommunicationsPanel;
	}
	...
	public void saveModel() throws IOException {
		...
		final VCard vcard = getModel(); //get the data model
		final LocaledText displayName = getIdentificationPanel().getFormattedName() != null ? getIdentificationPanel().getFormattedName() //use the formatted name as the display name
