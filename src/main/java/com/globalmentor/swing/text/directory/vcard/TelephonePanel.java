...
/**
 * A panel containing fields for the <code>TEL</code> type of a vCard <code>text/directory</code> profile as defined in <a
 * href="http://www.ietf.org/rfc/rfc2426.txt">RFC 2426</a>, "vCard MIME Directory Profile".
 * <p>
 * This panel allows actions to be added and automatically positioned as buttons.
 * </p>
...
public class TelephonePanel extends BasicVCardPanel {
	...
	public Action getEditTelephoneTypeAction() {
		return editTelephoneTypeAction;
	}
	...
	protected Set<Telephone.Type> getTelephoneTypes() {
	...
	/**
	 * @return An object representing the telephone information entered, or <code>null</code> if no telephone number was entered or the values violate ITU-T E.164.
	 */
	...
	*/
	 ...
	 * @param parentComponent The component that determines the <code>Frame</code> in which the dialog should be shown, or <code>null</code> if a default frame
	 *          should be used.
	 * @param telephoneType The current telephone type, one or more of the <code>Telephone.XXX_TELEPHONE_TYPE</code> constants ORed together.
	 * @return The new intended use, a combination of <code>Telephone.XXX_TELEPHONE_TYPE</code> constants ORed together.
	 */
