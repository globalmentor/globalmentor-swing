...
/**
 * A panel containing fields for the <code>EMAIL</code> type of a vCard <code>text/directory</code> profile as defined in <a
...
public class EmailPanel extends ModifiablePanel {
	...
	protected Set<Email.Type> getEmailTypes() {
		return emailTypes;
	}
	...
	*/
	 ...
	 * @param emailAddress The email address number to place in the fields, or <code>null</code> if default information should be displayed.
	 */
	...
	/**
	 * @return An object representing the email information entered, or <code>null</code> if no email information was entered.
	 */
