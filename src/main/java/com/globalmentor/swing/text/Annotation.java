...
import com.globalmentor.awt.Colors;
import com.globalmentor.java.Java;
import com.globalmentor.java.Objects;

/**
 * Represents a marked section with an optional length in a document that can survive edits and can be stored. An annotation maintains a highlight color and can
 * contain an optional note.
 * @see Bookmark
...
public class Annotation extends Bookmark {
	...
	/**
	 * @return The text of the bookmark, or <code>null</code> if this annotation has not text.
	 */
	 ...
	 * @param newText The text of the annotation, or <code>null</code> if there should be no text.
	 */
	...
	/**
	 * The highlight color, or <code>null</code> if this annotation is not highlighted.
	 */
	private Color color = null;

	/**
	 * @return The highlight color, or <code>null</code> if this annotation is not highlighted.
	 */
	 ...
	 * @param newColor The new highlight color, or <code>null</code> if there should be no highlight.
	 */
	...
	/**
	 * Constructs an annotation attached to a document at particular offsets with no color.
	 * @param document The document to which the bookmark should be attached.
	...
	/**
	 * Constructs an annotation attached to a document at particular offsets with a given color.
	 * @param document The document to which the bookmark should be attached.
	 * @param startOffset The starting offset in the document at which the annotation should be attached.
	 * @param endOffset The ending offset in the document at which the annotation should be attached.
	 * @throws BadLocationException Thrown if the given position does not represent a valid location in the document.
	...
	/**
	 * Constructs an annotation with a note attached to a document at a particular offset.
	...
	/**
	 * Compares this annotation to another annotation. This method determines order identically to <code>Bookmark</code>, and if bookmark-related items are equal
	 * the color and then the text is compared, with <code>null</code> values ranking before non-null values.
	 * @param object The object with which to compare the annotation. This must be another <code>Annnotation</code> object.
	 * @return A negative integer, zero, or a positive integer as this annotation is less than, equal to, or greater than the specified annotation, respectively.
	 * @throws ClassCastException Thrown if the specified object's type is not an <code>Annotation</code>.
	 */
