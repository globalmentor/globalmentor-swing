...
public class AnonymousElement implements Element //TODO isn't there a better name for this, that doesn't reflect just this one use?
{
	 ...
	 * @param attributes The attributes of this element.
	 * @param childElements The elements this element should contain.
	 * @param childElementStartIndex The index of the first child element to use (0&lt;=<code>childElementStartIndex</code>&lt;<code>childElements.length</code>).
	...
	/**
	 * @return The parent element, or <code>null</code> if this is a root level element.
	 */
	...
	/**
	 * @return <code>falsle</code> as anonymous elements should never be leaf elements.
	 */
