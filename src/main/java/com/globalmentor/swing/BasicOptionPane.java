 ...
 * </p>
 * <ul>
 * <li>If the message object implements {@link DefaultFocusable}, the initial focus component is given the focus when the pane is displayed.</li>
 * <li>If the message object implements {@link Verifiable}, the input is verified before the pane is allowed to close.</li>
 * <li>If {@link #setValue(Object)} is called with an explicit {@link Integer} value, that value will be returned even if options are present.</li>
 * </ul>
...
public class BasicOptionPane extends JOptionPane {
	...
	/**
	 * Creates a instance of <code>BasicOptionPane</code> to display a message using the plain-message message type and the default options delivered by the UI.
	 *
	...
	/**
	 * Creates an instance of <code>BasicOptionPane</code> to display a message with the specified message type and the default options,
	 *
	 * @param message the <code>Object</code> to display
	...
	/**
	 * Creates an instance of <code>BasicOptionPane</code> to display a message with the specified message type and options.
	 *
	 * @param message the <code>Object</code> to display
	 * @param messageType the type of message to be displayed: ERROR_MESSAGE, INFORMATION_MESSAGE, WARNING_MESSAGE, QUESTION_MESSAGE, or PLAIN_MESSAGE
	...
	/**
	 * Creates an instance of <code>BasicOptionPane</code> to display a message with the specified message type, options, and icon.
	 *
	 * @param message the <code>Object</code> to display
	 * @param messageType the type of message to be displayed: ERROR_MESSAGE, INFORMATION_MESSAGE, WARNING_MESSAGE, QUESTION_MESSAGE, or PLAIN_MESSAGE
	 * @param optionType the options to display in the pane: DEFAULT_OPTION, YES_NO_OPTION, YES_NO_CANCEL_OPTION OK_CANCEL_OPTION
	...
	/**
	 * Creates an instance of <code>BasicOptionPane</code> to display a message with the specified message type, icon, and options. None of the options is
	 * initially selected.
	 * <p>
	 * The options objects should contain either instances of <code>Component</code>s, (which are added directly) or <code>Strings</code> (which are wrapped in a
	 * <code>JButton</code>). If you provide <code>Component</code>s, you must ensure that when the <code>Component</code> is clicked it messages
	 * <code>setValue</code> in the created <code>BasicOptionPane</code>.
	 *
	 * @param message the <code>Object</code> to display
	 * @param messageType the type of message to be displayed: ERROR_MESSAGE, INFORMATION_MESSAGE, WARNING_MESSAGE, QUESTION_MESSAGE, or PLAIN_MESSAGE
	...
	/**
	 * Creates an instance of <code>BasicOptionPane</code> to display a message with the specified message type, icon, and options, with the initially-selected
	 * option specified.
	 *
	 * @param message the <code>Object</code> to display
	 * @param messageType the type of message to be displayed: ERROR_MESSAGE, INFORMATION_MESSAGE, WARNING_MESSAGE, QUESTION_MESSAGE, or PLAIN_MESSAGE
	 ...
	 *
	 * @param parentComponent determines the <code>Frame</code> in which the dialog is displayed; if <code>null</code>, or if the <code>parentComponent</code> has
	 ...
	 * @param messageType the type of message to be displayed: <code>ERROR_MESSAGE</code>, <code>INFORMATION_MESSAGE</code>, <code>WARNING_MESSAGE</code>,
	...
	/**
	 * Brings up a modal dialog where the number of choices is determined by the <code>optionType</code> parameter.
	 *
	 * @param parentComponent determines the <code>Frame</code> in which the dialog is displayed; if <code>null</code>, or if the <code>parentComponent</code> has
	 *          no <code>Frame</code>, a default <code>Frame</code> is used
	 * @param message the <code>Object</code> to display
	...
	/**
	 * Brings up a modal dialog where the number of choices is determined by the <code>optionType</code> parameter, where the <code>messageType</code> parameter
	 * determines the icon to display. The <code>messageType</code> parameter is primarily used to supply a default icon from the Look and Feel.
	 *
	 * @param parentComponent determines the <code>Frame</code> in which the dialog is displayed; if <code>null</code>, or if the <code>parentComponent</code> has
	 *          no <code>Frame</code>, a default <code>Frame</code> is used.
	 * @param message the <code>Object</code> to display
	...
	/**
	 * Brings up a modal dialog with a specified icon, where the number of choices is determined by the <code>optionType</code> parameter. The
	 * <code>messageType</code> parameter is primarily used to supply a default icon from the Look and Feel.
	 *
	 * @param parentComponent determines the <code>Frame</code> in which the dialog is displayed; if <code>null</code>, or if the <code>parentComponent</code> has
	 *          no <code>Frame</code>, a default <code>Frame</code> is used
	...
	/**
	 * Brings up a modal dialog with a specified icon, where the initial choice is dermined by the <code>initialValue</code> parameter and the number of choices
	 * is determined by the <code>optionType</code> parameter.
	 * <p>
	 * If <code>optionType</code> is YES_NO_OPTION, or YES_NO_CANCEL_OPTION and the <code>options</code> parameter is <code>null</code>, then the options are
	 ...
	 *          <code>String</code> objects are rendered using their <code>toString</code> methods; if this parameter is <code>null</code>, the options are
	...
	*/
	...
	/**
	 * Brings up a dialog with a specified icon, where the initial choice is determined by the <code>initialValue</code> parameter and the number of choices is
	 * determined by the <code>optionType</code> parameter.
	 * <p>
	 * If <code>optionType</code> is <code>YES_NO_OPTION</code>, or <code>YES_NO_CANCEL_OPTION</code> and the <code>options</code> parameter is <code>null</code>,
	 ...
	 * @param message the <code>Object</code> to display
	 * @param title the title string for the dialog
	 * @param optionType an integer designating the options available on the dialog: <code>YES_NO_OPTION</code>, or <code>YES_NO_CANCEL_OPTION</code>
	 * @param messageType an integer designating the kind of message this is, primarily used to determine the icon from the pluggable Look and Feel:
	 ...
	 *          <code>String</code> objects are rendered using their <code>toString</code> methods; if this parameter is <code>null</code>, the options are
	 *          determined by the Look and Feel
	 * @param initialValue the object that represents the default selection for the dialog; only meaningful if <code>options</code> is used; can be
	 *          <code>null</code>
	...
	/**
	 * Creates and returns a new <code>JDialog</code> wrapping <code>this</code> centered on the <code>parentComponent</code> in the <code>parentComponent</code>
	 * 's frame. <code>title</code> is the title of the returned dialog. The returned <code>JDialog</code> will be set up such that once it is closed, or the user
	 * clicks on the OK button, the dialog will be disposed and closed.
	 * <p>
	 * This version first verifies the content pane, if it is <code>Verifiable</code>, and only closes the dialog if the object verifies correctly or is not
	 * <code>Verifiable</code>.
	 * </p>
	 * @param parentComponent determines the frame in which the dialog is displayed; if the <code>parentComponent</code> has no <code>Frame</code>, a default
	 ...
	 * <p>
	 * This version first checks to see if the message implements <code>DefaultFocusable</code>, and if so the message is asked which component should get the
	 ...
	 * @return the <code>Frame</code> or <code>Dialog</code> that contains the component, or the default frame if the component is <code>null</code>, or does not
	 *         have a valid <code>Frame</code> or <code>Dialog</code> parent
	 */
