...
/**
 * PageEvent is used to notify interested parties that the displayed page has changed in the event source.
...
public class PageEvent extends EventObject {
	...
	/**
	 * The zero-based index of the page being displayed, or <code>-1</code> if no page is being displayed.
	 */
	private int pageIndex;

	/**
	 * @return The new zero-based page index, or <code>-1</code> if no page is being displayed.
	 */
