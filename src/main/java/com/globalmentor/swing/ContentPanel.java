 ...
 * <p>
 * This panel uses a {@link BasicGridBagLayout} as its layout manager, defaulting to the border paradigm.
 * </p>
 * <p>
 * If the panel is inside a <code>JOptionPane</code>, the window containing to ensure the component has enough room every time the content component changes.
 * </p>
 * <p>
 * If the content component implements <code>DefaultFocusable</code> and knows which component should get the default focus, any request for the default focus
 * component will be delegated to the content component.
 * </p>
 * <p>
 * If the content component implements <code>Modifiable</code>, any modifications of the content component will cause this panel to be modified. Setting the
 * modified status of this panel to <code>false</code> will also set the modified status of any <code>Modifiable</code> content component to <code>false</code>.
 * </p>
...
public class ContentPanel extends ModifiablePanel implements CanClosable {
	 ...
	 * @param constraints The position of the content component, such as <code>BorderLayout.CENTER</code> or a <code>GridBagConstraints</code> instance.
	 */
	...
	/**
	 * @return The main content component of the panel, or <code>null</code> if there is no content component.
	 */
	 ...
	 * <p>
	 * If the panel is inside a <code>JOptionPane</code>, the window containing to ensure the component has enough room.
	 * </p>
	 * @param newContentComponent The new content component for the panel, or <code>null</code> for no content component.
	 */
	...
	/**
	 * Returns the default focus component. If the content component implements <code>DefaultFocusable</code> and knows which component should get the default
	 * focus, any request for the default focus component will be delegated to the content component. Otherwise, whichever default focus component is set will be
	 * returned.
	...
	/**
	 * Content component constructor. The content component is guaranteed to be set before <code>initializeUI</code> is called.
	 * @param contentComponent The new component for the panel, or null if there should be no content component.
	 */
	...
	/**
	 * Content component constructor with center position and optional initialization. The content component is guaranteed to be set before
	 * <code>initializeUI</code> is called.
	 * @param contentComponent The new component for the center of the panel, or null if there should be no content component.
	 * @param initialize <code>true</code> if the panel should initialize itself by calling the initialization methods.
	 */
	...
	/**
	 * Content component constructor with constraints and optional initialization. The content component is guaranteed to be set before <code>initializeUI</code>
	 * is called.
	 * @param contentComponent The new component for the panel, or null if there should be no content component.
	 * @param constraints The position of the content component, such as <code>BorderLayout.CENTER</code> or a <code>GridBagConstraints</code> instance.
	 * @param initialize <code>true</code> if the panel should initialize itself by calling the initialization methods.
	...
	/**
	 * @return <code>true</code> if the panel can close. This request is delegated to the content pane if possible, and therefore any class that overrides this one
	 *         should call this version.
	...
	public boolean canClose() {
		...
		if(contentComponent instanceof CanClosable) //if the content component knows how to ask about closing
			...
			//if the content component doesn't know anything about closing		
