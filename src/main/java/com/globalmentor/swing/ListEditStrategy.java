...
public abstract class ListEditStrategy<E> extends ListModelEditStrategy<E> {
	...
	/**
	 * @return The currently selected index of the list model. This implementation return the lead selection index of the list selection model.
	...
	/**
	 * Sets the current main seletion index of the list model. This implementation sets the lead selection index of the list selection model.
	...
	/**
	 * Moves an item in the list. This implementation ensures the item retains its selection state.
