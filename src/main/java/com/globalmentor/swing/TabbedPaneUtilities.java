...
public class TabbedPaneUtilities {
	...
	/**
	 * If the given component has a tabbed pane as a parent, selects the tab of the tabbed pane that contains this component recursively up the hierarchy.
	 * @param component The component that may or may not be contained in one or more tabbed panes, or <code>null</code> if there is no component.
	 */
