...
/**
 * A panel allowing entry of an international public telecommunication number for geographic areas as defined in ITU-T E.164,
 * "The international public telecommunication numbering plan". The telephone number is formatted according to ITU-T E.123, "Notation for national and
...
public class TelephoneNumberPanel extends ModifiablePanel {
	...
	public JComboBox getCountryCodeComboBox() {
		return countryCodeComboBox;
	}
	...
	public JTextField getNationalDestinationCodeTextField() {
		return nationalDestinationCodeTextField;
	}
	...
	public JTextField getSubscriberNumberCodeTextField() {
		return subscriberNumberTextField;
	}
	...
	/**
	 * @return An object representing the telephone number information entered, or <code>null</code> if no telephone number was entered or the values violate ITU-T
	 *         E.164.
	 */
	...
	public void initializeUI() {
		...
		add(nationalDestinationCodeLabel,
				new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, Containers.NO_INSETS, 0, 0));
		add(nationalDestinationCodeTextField, new GridBagConstraints(1, 1, 1, 1, 0.5, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
		...
		add(subscriberNumberTextField, new GridBagConstraints(2, 1, 1, 1, 0.5, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, Containers.NO_INSETS,
				0, 0));
