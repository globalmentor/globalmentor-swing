 ...
 * <p>
 * Based on code from {@link DefaultListCellRenderer} version 1.17 02/02/00 by Philip Milne and Hans Muller, copyright 1998-2000 Sun Microsystems, Inc.
 * </p>
...
public class RadioButtonListCellRenderer extends JRadioButton implements ListCellRenderer, Serializable {
	 ...
	 * from the multi-parameter version, and returns the object's default <code>toString()</code> value.
	 * @param value The value of this list item.
	 * @return The correct text for this list item.
	 */
	...
	/**
	 * A subclass of <code>RadioButtonListCellRenderer</code> that implements UIResource. This class does not implement <code>UIResource</code> directly so that
	 * applications can safely override the cellRenderer property with <code>RadioButtonListCellRenderer</code> subclasses.
	 */
