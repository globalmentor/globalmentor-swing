...
/**
 * Component that displays an image. The image can be zoomed using a bound property Allows scrolling within a {@link JScrollPane}.
...
public class ImageComponent extends JComponent implements Scrollable {
	...
	/**
	 * Sets the amount to resize the image. This is a bound property, <code>ZOOM_PROPERTY</code>.
	 * @param newZoomFactor The zoom multiplier, with with <code>1</code> equal to no resizing.
	 */
	...
	/**
	 * The continuously updated image size, or <code>null</code> if the size is not known.
	 */
	private Dimension imageSize = null;

	/**
	 * @return The actual size of the image, or <code>null</code> if the size is not known.
	 */
	...
	/**
	 * The continuously updated zoom size of the image, or <code>null</code> if the zoom size is not known.
	 */
	private Dimension zoomSize = null;

	/**
	 * @return The zoom size of the image, or <code>null</code> if the zoom size is not known.
	 */
	 ...
	 * @param newZoomSize The new zoomed image size, or <code>null</code> if the zoom size is not known.
	 */
