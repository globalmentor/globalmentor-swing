 ...
 * <p>
 * By default progress is not visible until some change in progress.
 * </p>
 * <p>
 * By default status is not visible until some change in status.
 * </p>
...
public class StatusBar extends BasicToolBar {
	...
	protected BasicPanel getStatusComponentPanel() {
		return statusComponentPanel;
	}
	 ...
	 * @param visible <code>true</code> if general status should be visible, else <code>false</code> if it should be hidden.
	 */
	 ...
	 * <p>
	 * If text is not <code>null</code>, status visibility is turned on if it isn't already.
	 * </p>
	 * @param text The text to be displayed on the status label, or <code>null</code> if no text should be displayed.
	 */
	 ...
	 * @param visible <code>true</code> if progress should be visible, else <code>false</code> if it should be hidden.
	 */
	 ...
	 * <p>
	 * If text is not <code>null</code>, progress visibility is turned on if it isn't already.
	 * </p>
	 * @param text The text to be displayed on the progress bar, or <code>null</code> if no text should be displayed.
	 */
	 ...
	 * Sets the text to be displayed on the progress bar.
	 * <p>
	 * Progress visibility is turned on if it isn't already.
	 * </p>
	 * @param text The text to be displayed on the progress bar, or <code>null</code> if no text should be displayed.
