 ...
 * <p>
 * If a configuration is provided via <code>setConfiguration()</code>, that configuration is automatically loaded and saved.
 * </p>
...
public abstract class AbstractConfiguredFramedSwingApplication<C> extends AbstractFramedSwingApplication implements Modifiable {
	...
	/**
	 * @return The name of the configuration directory. If no configuration directory has been assigned, a default is returned constructed from the local name of
	 *         the application class in lowercase, preceded by a full stop character ('.').
	 */
	 ...
	 * @param configurationDirectoryName The name of the configuration directory, or <code>null</code> if the default should be used.
	 */
	protected void setConfigurationDirectoryName(final String configurationDirectoryName) {
		this.configurationDirectoryName = configurationDirectoryName;
	}

	/**
	 * @return The configuration directory for the application.
	 * @throws SecurityException if a security manager exists and its <code>checkPropertyAccess</code> method doesn't allow access to the user home system
	 *           property.
	 ...
	 * @param config The application configuration, or <code>null</code> if there should be no configuration.
	 */
	private void setConfiguration(final C config) {
	...
	public IOKit<C> getConfigurationIOKit() {
		return configurationIOKit;
	}

	/**
	 * Sets the configuration storage I/O kit.
	 * @param ioKit The configuration storage I/O kit, or <code>null</code> if there should be no configuration.
	 */
	protected void setConfigurationIOKit(final IOKit<C> ioKit) {
		configurationIOKit = ioKit;
	}
	...
	/**
	 * Initializes the application. This method is called after construction but before application execution. This version loads the configuration information,
	 * if it exists.
	...
	/**
	 * Creates a default configuration if one cannot be loaded. This version returns <code>null</code>.
	 * @return A default configuration, or <code>null</code> if the application does not need a configuration.
	 */
