...
/**
 * An adapter that can be added as a listener for mouse events, popping up a menu when the popup mouse button is pressed.
 * <p>
 * An instance of this class may installed into a component by calling {@link PopupAdapter#install(Component)} or by adding an instance of this class as a mouse
 * listener.
 * </p>
 * <p>
 * Typical uses of this class include any of the following:
 * </p>
 * <ul>
 * <li>Constructing the class with a default popup menu to always use.</li>
 * <li>Overriding {@link PopupAdapter#getPopupMenu()} to dynamically create a popup menu.</li>
 * <li>Overriding {@link PopupAdapter#getPopupMenu(Component, int, int)} to dynamically create a popup menu based on the specified coordinates in the given
 * component.</li>
 * </ul>
...
public class PopupAdapter extends MouseAdapter {
	...
	/**
	 * The popup menu to be shown by default, or <code>null</code> if there is no default popup menu.
	 */
	private JPopupMenu popupMenu;

	/**
	 * @return The popup menu to be shown by default, or <code>null</code> if there is no default popup menu.
	 */
	 ...
	 * @param popupMenu The popup menu to be shown by default, or <code>null</code> if there should be no default popup menu.
	 */
	...
	/**
	 * Installs the adapter in a component by adding itself as the correct listener.
	...
	/**
	 * Uninstalls the adapter from a component by removing itself as a listener.
	 ...
	 * <p>
	 * This version returns the default popup menu, if there is one.
	 * </p>
	 * @param component The component in whose space the popup menu is to appear.
	 * @param x The horizontal coordinate in invoker's coordinate space at which the popup menu is to be displayed.
	 * @param y The vertical coordinate in invoker's coordinate space at which the popup menu is to be displayed.
	 * @return The popup menu to be shown at the given coordinates in the specified component, or <code>null</code> if no popup menu should be shown.
	 * @see #getPopupMenu()
	 */
	...
	/**
	 * Shows a popup menu based upon the mouse event, which is assumed to be a popup trigger.
	 * @param mouseEvent The object containing mouse information about the event.
	 */
	 ...
	 * @param popupMenu The popup menu to show, or <code>null</code> if no popup menu should be shown.
	 * @param component The component in whose space the popup menu is to appear.
	 * @param x The horizontal coordinate in invoker's coordinate space at which the popup menu is to be displayed.
	 * @param y The vertical coordinate in invoker's coordinate space at which the popup menu is to be displayed.
	 */
