...
public class BasicDialog extends JDialog {
	...
	/**
	 * Creates a non-modal dialog without a title and without a specified <code>Frame</code> owner. A shared, hidden frame will be set as the owner of the dialog.
	 * <p>
	...
	/**
	 * Creates a non-modal dialog without a title with the specified <code>Frame</code> as its owner. If <code>owner</code> is <code>null</code>, a shared, hidden
	...
	/**
	 * Creates a modal or non-modal dialog without a title and with the specified owner <code>Frame</code>. If <code>owner</code> is <code>null</code>, a shared,
	...
	/**
	 * Creates a non-modal dialog with the specified title and with the specified owner frame. If <code>owner</code> is <code>null</code>, a shared, hidden frame
	...
	/**
	 * Creates a modal or non-modal dialog with the specified title and the specified owner <code>Frame</code>. If <code>owner</code> is <code>null</code>, a
	 * shared, hidden frame will be set as the owner of this dialog. All constructors defer to this one.
	 * <p>
	 * NOTE: Any popup components (<code>JComboBox</code>, <code>JPopupMenu</code>, <code>JMenuBar</code>) created within a modal dialog will be forced to be
	 * lightweight.
	 * <p>
	 * This constructor sets the component's locale property to the value returned by <code>JComponent.getDefaultLocale</code>.
	 *
	...
	/**
	 * Creates a modal or non-modal dialog with the specified title, owner <code>Frame</code>, and <code>GraphicsConfiguration</code>.
	 * 
	 * <p>
	 * NOTE: Any popup components (<code>JComboBox</code>, <code>JPopupMenu</code>, <code>JMenuBar</code>) created within a modal dialog will be forced to be
	 * lightweight.
	 ...
	 * @param title the <code>String</code> to display in the dialog's title bar
	 * @param modal true for a modal dialog, false for one that allows other windows to be active at the same time
	 * @param gc the <code>GraphicsConfiguration</code> of the target screen device. If <code>gc</code> is <code>null</code>, the same
	...
	/**
	 * Creates a modal or non-modal dialog with the specified title, owner <code>Dialog</code>, and <code>GraphicsConfiguration</code>.
	 * 
	 * <p>
	 * NOTE: Any popup components (<code>JComboBox</code>, <code>JPopupMenu</code>, <code>JMenuBar</code>) created within a modal dialog will be forced to be
	 * lightweight.
