...
/**
 * A tree node that represents a resource described in RDF. The resource is stored as the user object of the tree node. The string representation of the node is
 * the rdfs:label property of the resource, or the resource reference URI if there is no label present.
