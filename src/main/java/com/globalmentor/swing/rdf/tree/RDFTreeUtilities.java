...
public class RDFTreeUtilities {
	...
	/**
	 * Creates a tree node that recognizes resources representing a folder structure.
	...
	/**
	 * Creates a tree node to represent an RDF resource. If the resource is a folder resource that has child resources in an XPackage manifest, child resources
	 * are recursively created for those child resource.
