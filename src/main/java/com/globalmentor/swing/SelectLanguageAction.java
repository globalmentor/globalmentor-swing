...
public class SelectLanguageAction extends AbstractAction implements Localeable {
	...
	/**
	 * The locale that represents the language, or <code>null</code> if no language is indicated.
	 */
	...
	/**
	 * Determines the <code>Frame</code> in which the dialog is displayed; if <code>null</code>, or if the <code>parentComponent</code> has no <code>Frame</code>,
	...
	/**
	 * Locale constructor.
	 * @param locale The locale that represents the language, or <code>null</code> if no language should be initially indicated.
	 */
