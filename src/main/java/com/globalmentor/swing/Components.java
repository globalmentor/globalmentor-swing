...
/**
 * Convenience methods to be used for Swing components. Some of these methods apply to AWT components as well, but use the Swing utilities to acess the AWT
 * event queue and are therefore included in this package.
 * @see SwingUtilities
...
public class Components {
	...
	/**
	 * Sets the cursor using the AWT event queue, after all AWT events have been processed. Immediately returns the original cursor. This is useful for setting
	 * the cursor back to a particular value after invoking an operation in the AWT event queue and ensuring the cursor gets set back to its value after that
	 * operation finishes.
	 * @param component The component whose cursor should be set.
	 * @param cursor The new cursor the component should use.
	 * @return The cursor currently used by the component.
	...
	/**
	 * Scrolls the given rectangle to the origin of the parent. This is most useful if used with a component embedded in a <code>JViewport</code>.
