 ...
 * </p>
 * <p>
 * If the {@link Modifiable#MODIFIED_PROPERTY}is set to <code>false</code>, all all descendant components that implement {@link Modifiable} have their modified
 * properties set to <code>false</code> as well.
 * </p>
 * <p>
 ...
 * status to <code>true</code> when one of those children are modified. (Setting the modification status of those children to <code>false</code> will have no
 ...
 * components, will have listeners installed that change this panel's modification status to <code>true</code> in response to modifications in those components.
 * </p>
 * <p>
 * Bound properties:
 * </p>
...
public class ModifiablePanel extends BasicPanel implements Modifiable {
	...
	/**
	 * The lazily-created listener that modifies this panel when a <code>Modifiable</code> is modified.
	 */
	private PropertyChangeListener modifyModifiedPropertyChangeListener;

	/**
	 * @return The lazily-created listener that modifies this panel when a <code>Modifiable</code> is modified.
	 */
	...
	/**
	 * Adds appropriate listeners to this component or its descendants that will update this panel's modified status to <code>true</code> when descendant
	 * components are modified.
	 * <p>
	 * If the component or any of its descendants is <code>Modifiable</code>, a listener is added that changes this panel's modified status to <code>true</code>
	 * if the <code>Modifiable</code>'s modified status is changed to <code>true</code>.
	 * </p>
	 * <p>
	 * If the component is not <code>Modifiable</code>, any descendants of certain recognized types, such as text components and checkboxes, will have listeners
	 * registered that will change the modified status of this panel to <code>true</code> when those components are modified.
	 * </p>
	...
	/**
	 * Removes all modify listeners that were added within <code>addModifyListeners()</code>.
	...
	/**
	 * Creates an action listener that, when an action occurs, updates the modified status to <code>true</code>.
	 * @see #setModified
	 */
	...
	/**
	 * Creates a document listener that, when a document is modified, updates the modified status to <code>true</code>.
	 * @see #setModified
	 */
	...
	/**
	 * Creates a list selection listener that, when the list selection changes, updates the modified status to <code>true</code>.
	 * @see #setModified
	 */
	...
	*/
	...
	/**
	 * Creates a property change listener that, when the given property changes to the given value, updates the modified status to <code>true</code>.
	 * @param propertyName The name of the property that, when changed, will set the modified status to <code>true</code>.
	 * @param propertyValue The value of the property that, when equal to the new value, will set the modified status to <code>true</code>.
	 * @see #setModified
	 */
	...
	/**
	 * Creates a property change listener that, when the the "modified" property changes to <code>true</code>, updates the modified status to <code>true</code>.
	 * Convenience method.
	...
	/**
	 * Creates an item that, when an item is modified, updates the modified status to <code>true</code>.
	 * @see #setModified
	 */
	/*TODO fix or del
