...
public abstract class AbstractListModelComponentSequencePanel<E> extends AbstractComponentSequencePanel implements Editable {
	 ...
	 * @param newListModel The list model from which components are produced, or <code>null</code> for no list.
	 */
	 ...
	 * @param editStrategy The edit strategy for editing items in the list, or <code>null</code> if there is no edit strategy.
	 */
	...
	/**
	 * Sets whether the items in the list can be edited. This defaults to <code>false</code>. This is a bound property.
	 ...
	 * @param listModel The list the items of which the components in this sequence panel represent, or <code>null</code> for no list.
	 */
	 ...
	 * Constructor that allows optional initialization.
	 * @param listModel The list the items of which the components in this sequence panel represent.
	 * @param editStrategy The edit strategy for editing items in the list model, or <code>null</code> if this panel does not allow editing the list model.
	 * @param hasToolBar Whether this panel should have a toolbar.
	 * @param hasStatusBar Whether this panel should have a status bar.
	 * @param initialize <code>true</code> if the panel should initialize itself by calling the initialization methods.
	 */
