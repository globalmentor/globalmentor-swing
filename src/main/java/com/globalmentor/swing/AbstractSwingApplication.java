...
/**
 * An application that relies on Swing. This version creates a default authenticator for client authentication using Swing.
...
public abstract class AbstractSwingApplication extends AbstractApplication {
	...
	/**
	 * Displays an error message to the user for a throwable object, using a default title.
	...
	/**
	 * Displays an error message to the user, using the Swing application that owns the given parent component, if possible, with a default title.
	 * @param parentComponent The <code>Frame</code> in which the dialog is displayed, or <code>null</code> if a parent <code>Frame</code>, if any, of the
	 *          <code>parentComponent</code> should be used.
	 * @param message The error to display.
	...
	/**
	 * Displays an error message to the user, using the Swing application that owns the given parent component, if possible.
	 * @param parentComponent The <code>Frame</code> in which the dialog is displayed, or <code>null</code> if a parent <code>Frame</code>, if any, of the
	 *          <code>parentComponent</code> should be used.
	 * @param title The error message dialog title, or <code>null</code> for the default application error title.
	 * @param message The error to display.
	 ...
	 * @param parentComponent The <code>Frame</code> in which the dialog is displayed, or <code>null</code> if a parent <code>Frame</code>, if any, of the
	 *          <code>parentComponent</code> should be used.
	 * @param title The error message dialog title, or <code>null</code> for the default throwable error title.
	 * @param throwable The condition that caused the error.
	 */
	...
	/**
	 * Attempts to determine the <code>SwingApplication</code> for the given component. If the component has a parent <code>Frame</code> that is an
	 * <code>ApplicationFrame</code> that frame's application is returned if it has one.
	 * @param component The component that may have a parent <code>ApplicationFrame</code>.
	 * @return The Swing application object that owns this component, or <code>null</code> if a Swing application object could not be located.
	...
	/**
	 * Starts an application. This method should never return, as it directly calls {@link #exit()}.
