 ...
 * <p>
 * In order to create and edit items, an edit strategy must be set (besides setting the list to be editable using {@link ListPanel#setEditable(boolean)}. Actual
 * modification of the list will only be performed if the list uses a list model that implements either {@link DefaultListModel} or {@link List}.
 * </p>
 * <p>
 * Bound properties:
 * </p>
...
public class ListPanel<E> extends ContentPanel implements Editable {
	...
	public ListEditStrategy<E> getEditStrategy() {
		return editStrategy;
	}
