...
public class LanguagePanel extends BasicPanel {
	 ...
	 * @param locale The locale indicating the language, or <code>null</code> for no language.
	 */
	...
	/**
	 * @return A locale indicating the language selected, or <code>null</code> if no language is selected.
	 */
