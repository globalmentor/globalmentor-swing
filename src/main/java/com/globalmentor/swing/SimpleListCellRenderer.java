 ...
 * <p>
 * If it is desired that an icon be displayed, a child class should override <code>getListCellRendererIcon()</code> and return the correct icon for display.
 * </p>
...
public class SimpleListCellRenderer extends DefaultListCellRenderer {
	 ...
	 * @param isSelected Whether the list item is selected.
	 * @param cellHasFocus Whether the list item has the focus.
	 * @return The correct icon for this list item, or <code>null</code> if no icon should be displayed.
	 */
	 ...
	 * called from the multi-parameter version, and returns <code>null</code>.
	 * @param value The value of this list item.
	 * @return The correct icon for this list item, or <code>null</code> if no icon should be displayed.
	 */
