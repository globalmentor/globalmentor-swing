...
//TODO del whenw orks			if(XMLStyleConstants.isParagraphView(paragraphAttributeSet))  //if this element is not marked as a paragraph
	...
	/**Returns true if the text in the range <code>p0</code> to <code>p1</code>
		is left to right.
		Imported from {@link AbstractDocument} version 1.112 02/02/00 by
		Timothy Prinzing because that version has class access and cannot be called
		from the revised com.globalmentor.swing.text.GlyphPainter, which in turn
		has been taken out of its package so that it can be created by
		com.globalmentor.swing.text.TextLayoutStrategy, which had to be rewritten
