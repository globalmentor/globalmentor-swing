...
public class LinkLabel extends JLabel {
	...
	/**
	 * Sets the rollover color property. This is a bound property, <code>ROLLOVER_COLOR_PROPERTY</code>.
	...
	/**
	 * Sets the link target property. This is a bound property, <code>TARGET_PROPERTY</code>.
	 * @param newTarget The new link target, or <code>null</code> if the link has no destination.
	 */
