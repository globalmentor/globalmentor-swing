...
public abstract class XMLPanel<N extends Node> extends TabbedViewPanel<XMLNodeModel<N>> { //TODO make the toolbar and status bar an option
	...
	*/
	...
	protected JScrollPane getXMLScrollPane() {
		return xmlScrollPane;
	}
	...
	/** @return TODO testing */
	public Action getEmphasisAction() {
		return emphasisAction;
	}
	...
	/**
	 * @return An array of actions to use in a toolbar, with any <code>null</code> actions representing separators.
	 */
	/*TODO fix
