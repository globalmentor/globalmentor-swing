...
/**
 * Class implements the {@link DocumentListener} interface and provides a new {@link #modifyUpdate(DocumentEvent)} method that is called in response to either
 * {@link #insertUpdate(DocumentEvent)} or {@link #removeUpdate(DocumentEvent)} being called.
...
public class DocumentModifyAdapter extends DocumentAdapter {
	 ...
	 * @param documentEvent The document event. This version simply calls <code>modifyUpdate()</code>.
	 */
