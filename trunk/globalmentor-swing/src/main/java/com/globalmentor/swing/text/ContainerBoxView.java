 ...
 * <code>BoxView</code>. This class consequently determines view index based upon document position without relying on underlying element order and offsets.
...
public class ContainerBoxView extends BoxView implements Inset {
	...
	/**
	 * @return <code>true</code> if the cache is based upon recent information, even though there may not be a cached value available. This implementation not only
