...
public class Styles {
	...
	/**
	 * Checks whether the element has been specified as visible or hidden, without checking up the element hierarchy.
	 * @param attributeSet The attribute set.
	 * @return <code>true</code> if the visible attribute is <code>true</code> or not set, else <code>false</code> if the visible attribute is set to
	 *         <code>false</code>.
	 ...
	 * @param attributeSet The attribute set.
	 * @param visible <code>true</code> if the element should be visible, else <code>false</code> if the view created from the element should not be shown.
	 */
