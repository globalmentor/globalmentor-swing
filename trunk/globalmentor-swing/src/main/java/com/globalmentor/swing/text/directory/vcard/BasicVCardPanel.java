...
/**
 * A base panel for editing types of a vCard <code>text/directory</code> profile as defined in <a href="http://www.ietf.org/rfc/rfc2426.txt">RFC 2426</a>,
 * "vCard MIME Directory Profile".
 * <p>
 * By default a <code>GridBagLayout</code> is used as a layout manager.
 * </p>
...
public class BasicVCardPanel extends ModifiablePanel {
	...
	/**
	 * Creates a default styled button to be used for invoking the given select language action.
