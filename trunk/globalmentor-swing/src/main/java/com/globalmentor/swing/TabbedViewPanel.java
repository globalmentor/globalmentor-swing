...
/**
 * Panel that allows multiple views of data to be displayed in separate tabs. When the view value is changed, the appropriate tab is selected; when a new tab is
 * selected, the view value is changed accordingly.
 * <p>
 * The tabbed view panel uses a {@link BasicGridBagLayout} with a border paradigm.
 * </p>
 * <p>
 * Subclasses should set the correct default view only after initializing the tabs.
 * </p>
...
public abstract class TabbedViewPanel<M> extends ModelViewablePanel<M> {
	 ...
	 * @param view The view for which a tab should be returned; one of the <code>ModelViewable.XXX_DATA_VIEW</code> values.
	 * @return The component that represents the given view, or <code>null</code> if no tab component has been associated with the given view.
	 */
	 ...
	 * @return The view represented by the given component (one of the <code>ModelViewable.XXX_DATA_VIEW</code> values), or
	 *         <code>ModelViewable.NO_MODEL_VIEW</code> if there is no view associated with the given component
	 */
	...
	/**
	 * Associates a component with a particular view. The component should be one that is to appear on the tabbed pane, although this method does not itself add
	 * the component to the tabbed pane.
	 * <p>
	 * The view and component have a one-to-one relationship. Associating multiple components with a view or multiples views with a component will likely result
	 * in errant functionality.
	 * </p>
	 * @param view The view to associate with a component; one of the <code>ModelViewable.XXX_DATA_VIEW</code> values.
	 * @param component The component in the tabbed pane that represents the given view.
	 */
	 ...
	 * <p>
	 * An appropriate default icon is used for the given view if possible.
	 * @param view The view to associate with a component; one of the <code>ModelViewable.XXX_DATA_VIEW</code> values.
	 * @param title The title to be displayed on the tab.
	 * @param component The component to be displayed on the tab that represents the given view.
	 */
	 ...
	 * @param title The title to be displayed on the tab.
	 * @param component The component to be displayed on the tab that represents the given view.
	 * @param tip The tooltip to be displayed on the tab, or <code>null</code> for no tip.
	 */
	 ...
	 * @param view The view to associate with a component; one of the <code>ModelViewable.XXX_DATA_VIEW</code> values.
	 * @param title The title to be displayed on the tab.
	 * @param icon The icon to be displayed on the tab, or <code>null</code> for no icon.
	 * @param component The component to be displayed on the tab that represents the given view.
	 */
	...
	/**
	 * Determines whether it is appropriate under the circumstances to change the model view. This method may display any necessary dialog boxes in response to
	 * any error conditions before returning.
	 * <p>
	 * This version verifies only the current view component.
	 * </p>
	 * @param oldView The view before the change.
	 * @param newView The new view of the data
	 * @return <code>true</code> if the model view change should be allowed, else <code>false</code>.
	 */
	...
	/**
	 * Updates the selected tab to reflect the current view. If the correct tab is already selected, no action occurs.
