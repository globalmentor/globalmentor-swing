...
/**
 * A panel allowing entry of one or more addresses of a vCard <code>text/directory</code> profile as defined in <a
...
public class AddressesPanel extends ContentPanel {
	...
	public Action getAddAddressAction() {
	...
	public Action getAddLabelAction() {
	...
	public Action getRemoveAddressAction() {
		return removeAddressAction;
	}
	...
	protected JTabbedPane getTabbedPane() {
		return (JTabbedPane)getContentComponent();
	}
	...
	*/
	...
	/**
	 * Places the addresses and labels into the tabs. If both arrays are empty, a default address will be placed in the first tab.
	...
	/**
	 * Addresses constructor. If both arrays are empty, a default address will be placed in the first tab.
	 * @param addresses The addresses to place in the tabs.
	 * @param labels The labels to place in the tabs.
	 */
