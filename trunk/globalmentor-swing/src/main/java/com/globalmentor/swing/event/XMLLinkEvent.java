...
/**
 * An event which represents a link within XML. Besides the normal {@link HyperlinkEvent} properties, this link is primarily concerned with the link URI rather
 * than the link URL.
...
public class XMLLinkEvent extends HyperlinkEvent {
	...
	/**
	 * Creates a new object representing an XML link event. The other constructor is preferred, as it provides more information if a URI could not be formed. This
	 * constructor is primarily for backward compatibility.
	 ...
	 * @param source The object responsible for the event.
	 * @param type The event type.
	 * @param uri The affected URI. This may be <code>null</code> if a valid URI could not be created.
	 * @param description The description of the link. This may be useful when attempting to form a URI resulted in a URISyntaxException. The description provides
	 *          the text used when attempting to form the URI.
	 */
	 ...
	 * @param description The description of the link. This may be useful when attempting to form a URI resulted in a URISyntaxException. The description provides
	 *          the text used when attempting to form the URI.
	 * @param sourceElement The Element in the Document representing the anchor
	 * @since 1.4
	 */
