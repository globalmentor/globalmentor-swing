...
public class AttributeSets //TODO do we really want this class with a Styles class?
{
	...
	/**
	 * Constructs a string representing the names and values of the attribute set. This method is modified from the code found in <code>ElementTreePanel</code>,
	 * Copyright (c) 1998, 1999 by Sun Microsystems, Inc., written by Scott Violet version 1.9 04/23/99.
	 * @param attributeSet The attribute set for which a representational string should be returned.
	 * @return A string representation of the contents of the attribute set, or the empty string if the attribute set is <code>null</code>.
	 */
