...
public class XMLParagraphView extends ParagraphView implements Inset, XMLCSSView, FragmentViewFactory //TODO del if not needed, ViewReleasable
{
	...
	/**
	 * The justification of the paragraph. This is an override of the <code>ParagraphView</code> version because ParagraphView provides no accessor functions.
	 */
	...
	/**
	 * Sets the justification of the paragraph. This is present because <code>ParagraphView</code> ParagraphView provides no accessor functions for justification.
	...
	/**
	 * The line spacing of the paragraph. This is an override of the <code>ParagraphView</code> version because ParagraphView provides no accessor functions.
	 */
	...
	/**
	 * Sets the line spacing of the paragraph. This is present because <code>ParagraphView</code> ParagraphView provides no accessor functions for line spacing.
	...
	/**
	 * Whether the first line should be indented according to the specified indentation. A value of <code>false</code> will override any specified setting.
	 */
	...
	/**
	 * Sets whether the first line should be indented. If this is set to <code>false</code> (if, for example, there is an image and no text), any specified
	 * first-line indent value will be ignored.
	 * @param newFirstLineIndented <code>true</code> if the first line should be indented according to the indention value, <code>false</code> if that value
	 *          should be ignored.
	 */
	...
	*/
	...
	/**
	 * Sets the cached properties from the attributes. This overrides the version in <code>ParagraphView</code> to work with CSS attributes.
	 */
	...
	/**
	 * Returns the location along the flow axis that the flow span will start at. This is overridden to correctly indent first lines of paragraphs, if needed
	...
	/**
	 * Loads all of the children to initialize the view. This is called by the <code>setParent</code> method. This is reimplemented to not load any children
	 * directly, as they are created in the process of formatting. If the layoutPool variable is <code>null</code>, an instance of <code>LinePoolView</code> is
	 * created to represent the logical view that is used in the process of formatting. This version of <code>loadChildren</code> is implemented to return
	 * specifically a <code>XMLParagraphView.LinePoolView</code>, so that that view can implement its own special version of child view construction.
	 ...
	 * <dl>
	 * <dt><code>View.BadBreakWeight</code></dt>
	 * <dd>If the desired break location is less than the first child is comfortable with (i.e. not even one child view can fit), or there are no child views</dd>
	 * <dt><code>View.GoodBreakWeight</code></dt>
	 * <dd>If the other conditions don't occur.</dd>
	 * </dl>
	...
	protected class LinePoolView extends ContainerView {
		...
		/**
		 * Loads all of the children to initialize the view. This is called by the <a href="#setParent">setParent</a> method. This version initially attempts to
		 ...
		 * </p>
		 * @param elementChange The change information for the element this view is responsible for. This should not be <code>null</code> if this method gets
		 *          called.
	 ...
	 * upward to the next parent. The root view will call <code>revalidate</code> on the associated text component.
	 *
