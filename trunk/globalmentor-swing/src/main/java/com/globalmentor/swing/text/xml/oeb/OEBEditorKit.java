...
package com.globalmentor.swing.text.xml.oeb;
...
public class OEBEditorKit extends XEBEditorKit {
	 ...
	 */
	public Object clone() {
		return new OEBEditorKit(getURIInputStreamable());
	}
	...
	public String getContentType() {
		return OEB.OEB10_PACKAGE_MEDIA_TYPE.toString();
	}
	...
	public void read(final InputStream inputStream, final Document document, final int pos) throws IOException, BadLocationException {
		if(document instanceof XMLDocument) { //if this is a Swing XML document
			...
			final DocumentBuilder documentBuilder = XML
					.createDocumentBuilder(true, new URIInputStreamableXMLEntityResolver(swingXMLDocument.getURIInputStreamable())); //create a new processor for loading the package information				
