...
/**
 * A panel allowing entry of the "ADR" type of a vCard <code>text/directory</code> profile as defined in <a href="http://www.ietf.org/rfc/rfc2426.txt">RFC
...
public class AddressPanel extends BasicVCardPanel {
	...
	public Action getEditAddressTypeAction() {
		return editAddressTypeAction;
	}
	...
	protected Set<Address.Type> getAddressTypes() {
		return addressTypes;
	}
	...
	public JTextField getPostOfficeBoxTextField() {
		return postOfficeBoxTextField;
	}
	...
	public JTextPane getStreetAddressTextPane() {
		return streetAddressTextPane;
	}
	...
	public JTextField getLocalityTextField() {
	...
	public JComboBox getCountryNameComboBox() {
		return countryNameComboBox;
	}
	 ...
	 * @param address The address to place in the fields, or <code>null</code> if no information should be displayed.
	 */
	...
	/**
	 * @return An object representing the address information entered, or <code>null</code> if no address was entered.
	 */
	...
	public void initializeUI() {
		...
		add(postOfficeBoxTextField,
				new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, Containers.NO_INSETS, 0, 0));
	 ...
	 * @return <code>true</code> if the user accepted the changes and the type was updated, otherwise <code>false</code> if the user cancelled.
	 */
