 ...
 * <p>
 * This class recognizes the XHTML anchor tag <code>&lt;a&gt;</code>, and also allows the parent class to properly interpret XLink links.
 * </p>
 */
public class XHTMLLinkController extends XMLLinkController {
	...
	/**
	 * Determines whether the specified element represents a link. This version returns <code>true</code> for every XHTML anchor element (<code>&lt;a&gt;</code>);
	...
	/**
	 * Gets the link href of the specified element if the specified element represents a link. This version returns the value of the <code>href</code> attribute
	 * of an anchor tag, and allows the parent class to determine the href for all other elements.
