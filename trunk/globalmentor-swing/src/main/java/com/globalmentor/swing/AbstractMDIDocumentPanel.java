...
/**
 * An application panel that contains a document for multiple document interface architecture.
...
//TODO make this class implement com.globalmentor.io.Streamable as well (create that class)
	...
	/**
	 * Sets whether the data has been modified. This is a bound property.
	 ...
	 */
	public void setObject(final RDFResource resource) {
		this.resource = resource;
	} //TODO maybe throw an exception if the resource is null

	/**
	 * Sets the reference URI of the document. This results in the resource returned by <code>getResource()</code> being changed to another object, invalidating
	 * the old resource description.
	 * @param referenceURI The new reference URI of the document.
	 * @throws IllegalArgumentException Thrown if the provided reference URI is <code>null</code>.
	 */
	/*TODO del when works
	...
	*/
	...
	/**
	 * Creates any application objects and initializes data. Any class that overrides this method must call this version.
	 */
	/*TODO del
	...
	*/
	...
	/**
	 * Loads the resource by reading the contents of the resource from the given input stream. Convenience implementation to read with no description.
