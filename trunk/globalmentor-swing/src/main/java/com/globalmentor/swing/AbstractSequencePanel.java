...
public abstract class AbstractSequencePanel extends ToolStatusPanel {
	 ...
	 * @param distinct <code>true</code> if there should be distinct buttons for start, next, and finish, or <code>false</code> if one button should share these
	 *          responsibilitiese.
	 */
	 ...
	 * @param newConfirmingAction The action to perform if confirmation is received, or <code>null</code> if no action should be pending confirmation.
	 */
	 ...
	 * <p>
	 * Derived classes should override <code>start()</code>.
	 * </p>
	 * @see #start
	 */
	public void goStart() {
	 ...
	 * <p>
	 * Derived classes should override <code>first()</code>.
	 * </p>
	 * @see #first
	 */
	public void goFirst() {
	 ...
	 * <p>
	 * Derived classes should override <code>previous()</code>.
	 * </p>
	 * @see #previous
	 */
	 ...
	 * <p>
	 * Derived classes should override <code>next()</code>.
	 * </p>
	 * @see #next
	 */
	public void goNext() {
	...
	/**
	 * Verifies the contents and finishes the sequence. Usually a derived class will not modify this method and instead override <code>finish()</code>, which this
	...
	/**
	 * Finishes the sequence. This version sets the option panel value to <code>JOptionPane.OK_OPTION</code> if this panel is embedded in an option pane.
	...
	/**
	 * Creates and displays a sequence dialog based upon <code>JOptionPane</code>, showing this sequence panel.
	 * <p>
	 * This method does not start the sequence. The calling method may start the sequence before calling this method by invoking <code>goStart()</code>.
	 * </p>
