...
/**
 * A panel containing fields for the identification types of a vCard <code>text/directory</code> profile as defined in <a
...
public class IdentificationPanel extends BasicVCardPanel {
	...
	public SelectLanguageAction getSelectFormattedNameLanguageAction() {
		return selectFormattedNameLanguageAction;
	}
	...
	public SelectLanguageAction getSelectNicknameLanguageAction() {
		return selectNicknameLanguageAction;
	}
	...
	/**
	 * Whether, the last time the formatted name was updated, it matched the the default formatting of the name.
	 */
	 ...
	 * @param formattedName The name to place in the field, or <code>null</code> if no information should be displayed.
	 */
	...
	/**
	 * @return The formatted name entered, or <code>null</code> if no formatted name was entered.
	 */
	 ...
	 * @param nicknames The nicknames to place in the field, or <code>null</code> if no information should be displayed.
	 */
	...
	public LocaledText[] getNicknames() {
		...
		return LocaledText.toLocaleTextArray(StringTokenizers.getTokens(new StringTokenizer(nicknameTextField.getText().trim(), VALUE_DELIMITERS)),
				selectNicknameLanguageAction.getLocale());
	}
	...
	public void initializeUI() {
		...
		add(selectNicknameLanguageButton,
				new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.NONE, Containers.NO_INSETS, 0, 0));
		...
		add(selectFormattedNameLanguageButton, new GridBagConstraints(3, 1, 1, 1, 0.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.NONE, Containers.NO_INSETS,
				0, 0));
		add(formattedNameTextField,
				new GridBagConstraints(2, 2, 2, 1, 0.6, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, Containers.NO_INSETS, 0, 0));
	}
