...
/**
 * A panel allowing entry of the explanatory types of a vCard <code>text/directory</code> profile as defined in <a
...
public class ExplanatoryPanel extends BasicVCardPanel {
	...
	public SelectLanguageAction getSelectCategoryLanguageAction() {
		return selectCategoryLanguageAction;
	}
	...
	public SelectLanguageAction getSelectNoteLanguageAction() {
		return selectNoteLanguageAction;
	}
	 ...
	 * @param url The URL information to place in the field, or <code>null</code> if there is no URL.
	 */
	...
	/**
	 * @return An object representing the URL entered, or <code>null</code> if no URL number was entered or the text is not a valid URI.
	 */
	public URI getURL() {
	...
	public void initializeUI() {
		...
		add(selectCategoryLanguageButton,
				new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.NONE, Containers.NO_INSETS, 0, 0));
	...
	class SelectCategoryLanguageAction extends SelectLanguageAction {
		...
		/**
		 * @return The locale that represents the language, or <code>null</code> if no language is indicated.
		 */
		...
		/**
		 * Sets the language.
		 * @param newLocale The locale that represents the language, or <code>null</code> if no language should be indicated.
		 */
