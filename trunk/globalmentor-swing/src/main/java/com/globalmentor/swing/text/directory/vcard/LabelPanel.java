...
/**
 * A panel allowing entry of the "LABEL" type of a vCard <code>text/directory</code> profile as defined in <a href="http://www.ietf.org/rfc/rfc2426.txt">RFC
...
public class LabelPanel extends BasicVCardPanel {
	...
	public JTextPane getLabelTextPane() {
		return labelTextPane;
	}
	 ...
	 * @param label The label to place in the fields, or <code>null</code> if no information should be displayed.
	 */
	...
	/**
	 * @return An object representing the label information entered, or <code>null</code> if no label was entered.
	 */
