...
/**
 * A panel allowing entry of the organization types of a vCard <code>text/directory</code> profile as defined in <a
...
public class OrganizationPanel extends BasicVCardPanel {
	...
	public SelectLanguageAction getSelectOrganizationNameLanguageAction() {
		return selectOrganizationNameLanguageAction;
	}
	...
	public JTextField getUnitsTextField() {
	...
	public SelectLanguageAction getSelectTitleLanguageAction() {
		return selectTitleLanguageAction;
	}
	...
	public SelectLanguageAction getSelectRoleLanguageAction() {
		return selectRoleLanguageAction;
	}
	...
	public LocaledText getOrganizationName() {
		final String name = Strings.asNonEmptyString(nameTextField.getText().trim());
	...
	public LocaledText[] getUnits() {
		...
		return LocaledText.toLocaleTextArray(StringTokenizers.getTokens(new StringTokenizer(unitsTextField.getText().trim(), UNIT_DELIMITERS)),
				selectOrganizationNameLanguageAction.getLocale());
	}
	...
	public LocaledText getJobTitle() {
		final String title = Strings.asNonEmptyString(titleTextField.getText().trim());
	...
	public LocaledText getRole() {
		final String role = Strings.asNonEmptyString(roleTextField.getText().trim());
	...
	public void initializeUI() {
		...
		add(selectOrganizationNameLanguageButton, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.NONE,
