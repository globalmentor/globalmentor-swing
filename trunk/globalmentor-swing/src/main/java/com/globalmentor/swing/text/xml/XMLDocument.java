...
public class XMLDocument extends BasicStyledDocument {
	 ...
	 * @return The resource, if it has been cached and is still referenced in the JVM, or <code>null</code> if the resource's memory has been reclaimed or the
	...
	*/
	 ...
	 * <li>audio/* - <code>javax.sound.sampled.Line</code> Usually this will be of type <code>javax.sound.sampled.Clip</code> and will have been opened.</li>
	 * </ul>
	...
	/**
	 * Gets the URI of a particular resource. If the given <code>href</code> is relative, it is correctly normalized to an absolute URI. This version assumes
	 * relative locations are relative to the base URI unless the base URI is <code>null</code>, in which case the href is assumed to be absolute.
	 * @param href The specified location of the resource.
	 ...
	 * @param href The specified location of the resource.
	 * @return The media type of the specified resource, or <code>null</code> if the media type cannot be determined.
	 */
	...
	/**
	 * Initialize the document to reflect the given element structure (i.e. the structure reported by the <code>getDefaultRootElement</code> method. If the
	...
	*/
	...
	/**
	 * Notifies all listeners that have registered interest for notification on this event type. The event instance is lazily created using the parameters passed
	...
	*/
	 ...
	 * @return The element with the matching attribute, or <code>null</code> if none could be found.
	 */
	...
	/**
	 * Returns the child element of the specified element that contains the desired attribute with the given value, or <code>null</code> if no element has an
	 * attribute with the desired value. This function is not thread-safe. //TODO del if not needed If <code>searchLeafAttributes</code> is true, and the element
	...
	*/
	 ...
	 * <p>
	 * The paragraph elements of <code>XMLDocument</code> can have multiple sub-layers of elements, representing nested XML elements such as
	 * <code>&lt;strong&gt;</code>; these will be translated into a single layer of views for each string of content.
	 * </p>
	 * <p>
	 * The <code>DefaultStyledDocument</code> version of this element, on the other hand, assumes that each paragraph will only have one single layer of content
	 ...
	 * to that of <code>DefaultStyledDocument</code>.
	 * </p>
	 * <p>
	...
	*/
	...
	protected class SwingXMLCSSStylesheetApplier extends AbstractXMLCSSStylesheetApplier<Element, Element> {
		...
		/**
		 * Determines if the given indexed child of an element is an element. This version always returns <code>true</code>, as all Swing element children are also
		 * elements.
		 * @param element The parent element.
