...
public class ModelPanel<M> extends ModifiablePanel implements ModelView<M> {
	 ...
	 * <p>
	 * A calling program should first call <code>verify()</code> to ensure the data is valid and that the model reflects the currently entered data.
	...
	/**
	 * Sets the data model. This is a bound property.
	 ...
	 * <p>
	 * This version saves any editing changes to the model.
	 * </p>
