 ...
 * <p>
 * The XML view factory adds a special capability of defining view factories for specific namespaces. If an XML element is encountered in a particular namespace
 * and a view factory has been registered for that namespace, the registered view factory will be used to create the view. Otherwise, this view factory will
 * create a view.
 * </p>
 * <p>
...
public class XMLViewFactory implements ViewsFactory {
	 ...
	 * creation will be delegated to the designated view factory.
	...
	/**
	 * Creates one or more views for the given element. If the element specifies a namespace and a view factory has been registered for the given namespace, the
	 * view creation will be delegated to the designated view factory. This method allows one element (such as a nested inline element within a paragraph) to be
	 * represented by one level of multiple views rather than a hierarchy of views.
	...
	*/
	...
	public View create(final Element element, final boolean indicateMultipleViews) {
		...
		if(indicateMultipleViews) { //if we should indicate multiple views are needed
			...
			//if we're not allowed to indicate multiple views
	...
	/**
	 * Retreives a view factory for the given namespace. This version defaults to returning this view factory. A child class can override this method to return a
	 * view factory specifically for a given namespace.
	 * @param namespaceURI The namespace URI of the element for which a view factory should be returned, or <code>null</code> if the element has no namespace.
