...
public abstract class ResourceComponentManager<R extends Resource> implements Preferencesable {
	...
	public ResourceSelector<R> getResourceSelector() {
	...
	protected final Iterable<ResourceComponentState> getResourceComponentStates() {
	 ...
	 * @return The component state of the resource, if that resource is already known, or <code>null</code> if no resource with that URI is present.
	 */
	 ...
	 * @return The component state of the resource, if there is a resource with the given component, or <code>null</code> if no resource with that component is
	 *         present.
	 */
	...
	*/
	 ...
	 * @return An object representing the opened resource and its state, or <code>null</code> if the process was canceled.
	 ...
	 * </p>
	 * <p>
	 * By default if no location is available, the <code>saveAs</code> method is called. If a location is available, <code>save(Resource)</code> is called.
	 * </p>
	 * <p>
