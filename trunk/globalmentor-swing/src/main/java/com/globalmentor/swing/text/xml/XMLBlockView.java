...
/**
 * A view that arranges its children into a box shape by tiling its children along an axis. Any non-block child views are wrapped in anonymous block views.
...
public class XMLBlockView extends ContainerBoxView implements XMLCSSView, FragmentViewFactory {
	...
	/**
	 * Creates block views for given elements. This is called by the <a href="#loadChildren">loadChildren</a> method as well as other block-like classes such as
	 * tables. Inline children will not be created normally but will be wrapped in one or more anonymous views. Inline views consisting only of whitespace will be
	 * given hidden views.
	...
	/**
	 * Ensures that each given element is a block element. Inline child elements will be wrapped in one or more anonymous elements.
	 * @param parentElement The element that will be used as the parent of any anonymous block children created.
	...
	*/
	...
	/**
	 * Renders the block view using the given rendering surface and area on that surface. Only the children that intersect the clip bounds of the given
	 * <code>Graphics</code> will be rendered. This version correctly paints XML CSS style.
