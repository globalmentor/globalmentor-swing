...
public class Menus {
	...
	/**
	 * Retrieves the first menu element that represents the given action. This method first checks to see if the given menu element represents the action. Then,
	 * each submenu present is recursively checked to see if one represents the action.
	 * @param menuElement The menu element hierarchy to check.
	 * @param action The action for which a menu element should be returned.
	 * @return The menu element, such as a menu item, that represents the given action, or <code>null</code> if no menu element represents the given action.
	 */
