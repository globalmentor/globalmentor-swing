 ...
 * <p>
 * In this version, {@link FocusTargetAction#setTarget(Object)} sets the default target for the situation in which there is no focus owner.
 * </p>
...
public abstract class FocusTargetAction extends TargetAction {
	 ...
	 * <p>
	 * This version checks to see if any component owns the focus. If so, that component is returns. If not, the default target is returned.
	 * </p>
	 * @return The current focus owner component, or the default target of the action if there is no focus owner, or <code>null</code> if there is no default
	 *         target.
	 * @see #getFocusOwner()
	 * */
	 ...
	 * <p>
	 * If a derived class wants to only recognize certain focused targets, it should override this method and return <code>null</code> if the currently focused
	 * component is not of the correct type.
	 * </p>
	 * @return The current focus owner, or <code>null</code> if there is no current focus owner.
	 ...
	 * @param name The name description of the action.
	 * @param defaultTarget The default target component, or <code>null</code> if there should be no default target.
	 */
